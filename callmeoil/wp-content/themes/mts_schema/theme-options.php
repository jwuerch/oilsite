...
if ( ! MTS_THEME_WHITE_LABEL ) {
	...
	$args['help_tabs'][] = array(
		...
		'content' => '<p>' . sprintf( __('Earn 70%% commision on every sale by refering your friends and readers. Join our %s.', 'schema' ), '<a href="http://mythemeshop.com/affiliate-program/">' . __( 'Affiliate Program', 'schema' ) . '</a>' ) . '</p>'
	);
}
...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'options' => array( '0' => __( 'Off', 'schema' ), '1' => __( 'On', 'schema' ) ),
						'sub_desc' => sprintf( __('Remove %s parameter from CSS and JS file calls. It may improve speed in some browsers which do not cache files having the parameter.', 'schema' ), '<code>ver</code>' ),
						'std' => '1',
						'reset_at_version' => '3.0'
						),
					array(
...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'options' => array( '0' => __( 'Off', 'schema' ), '1' => __( 'On', 'viral' ) ),
...
$sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'args' => array('allow_nosidebar' => true, 'exclude' => array('sidebar', 'footer-top', 'footer-top-2', 'footer-top-3', 'footer-top-4', 'widget-header','shop-sidebar', 'product-sidebar')),
                        'std' => 'shop-sidebar'
						),
                    array(
