...
<div class="featured-image-box">
	<div class="featured-image-wrap">
		...
		?>
			...
			<h1 class="title single-title entry-title container"><?php the_title(); ?></h1>
...
<div id="page" class="<?php mts_single_page_class(); ?>">
	...
	<article class="<?php mts_article_class(); ?>">
		<span class="affiliate-text">Disclosure: Some of the links in this post may be affiliate links and we may receive commission or compensation. Read our privacy policy for more information.</span>
				...
				<div id="post-<?php the_ID(); ?>" <?php post_class('g post'); ?>>
					...
					foreach( $single_post_parts as $part => $label ) {
						switch ($part) {
							...
							case 'tags':
								?>
								<?php mts_the_tags('<div class="tags"><span class="tagtext">'.__('Tags', 'schema' ).':</span>',', ') ?>
								<?php
							break;
							...
							case 'author':
								...
								<div class="postauthor">
									<h4><?php _e('About The Author', 'schema' ); ?></h4>
